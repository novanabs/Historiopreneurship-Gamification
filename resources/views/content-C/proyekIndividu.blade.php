...
<ul class="nav nav-tabs" id="myTab" role="tablist">
    ...
    <li class="nav-item" role="presentation">
        <button class="nav-link" id="rancangan-proyek-tab" data-bs-toggle="tab" data-bs-target="#rancangan-proyek"
            type="button" role="tab" aria-controls="rancangan-proyek" aria-selected="false">Rancangan Proyek</button>
    </li>
    <li class="nav-item" role="presentation">
        <button class="nav-link" id="pengumpulan-laporan-tab" data-bs-toggle="tab" data-bs-target="#pengumpulan-laporan"
            type="button" role="tab" aria-controls="pengumpulan-laporan" aria-selected="false">Pengumpulan Laporan</button>
    </li>
</ul>
...
<div class="tab-content mt-3" id="myTabContent">
    ...
    <div class="tab-pane fade" id="rancangan-proyek" role="tabpanel" aria-labelledby="rancangan-proyek-tab">
        ...
        <textarea name="analisaProduk" id="analisaProduk" class="form-control w-100 mt-2" rows="5">{{ old('analisaProduk', $jawabanIndividu['Analisa produk atau jasa yang digunakan'] ?? '') }}</textarea>
        <hr>
        ...
        <textarea name="langkahKerja" id="langkahKerja" class="form-control w-100 mt-2" rows="5">{{ old('langkahKerja', $jawabanIndividu['langkah kerja'] ?? '') }}</textarea>
            <div class="row mt-2">
                <div class="col">
