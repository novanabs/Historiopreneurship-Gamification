...
<form  action="{{ route('simpanAktivitas') }}" method="POST">
    ...
    <ul class="list-unstyled">
        <li class="mt-3">
            <label for="jenisTeknologi" class="fw-semibold">Jenis-jenis teknologi yang berpengaruh terhadap dunia pemasaran produkproduk yang berkaitan dengan kewirausahaan kesejarahan:</label> <br>
        ...
        <li class="mt-3">
            <label for="pengaruhTeknologi" class="fw-semibold">Bagaimana pengaruh teknologi tersebut terhadap proses pemasaran kewirausahaan kesejarahan:</label> <br>
        ...
        <li class="mt-3">
            <label for="kelebihanKekuranganTeknologi" class="fw-semibold">Kelebihan dan kekurangan penggunaan teknologi dalam proses pemasaran kewirausahaan kesejarahan:</label> <br>
            <textarea class="form-control w-100 mt-2" name="jawaban[kelebihanKekuranganTeknologi]" id="kelebihanKekuranganTeknologi"
        ...
        <li class="mt-3">
            <label for="kondisiProses" class="fw-semibold">Analisislah kondisi proses pemasaran sebelum dan sesudah ditemukannya teknologi khususnya platform pemasaran digital:</label> <br>
